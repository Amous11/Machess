...
namespace BrokenMugStudioSDK
{
    ...
    public class ScreenshotsEditor
    {
        ...
        public string SavePath { get => EditorPrefs.GetString(Constants.k_ScreenShotsEditorPrefKey, "D:/BrokenMugStudio/Screenshots"); set => EditorPrefs.SetString(Constants.k_ScreenShotsEditorPrefKey, value); }
        ...
        private const string k_VMFastlaneScreenshots = "D:/BrokenMugStudio/Screenshots/";
